...
namespace OpenBve {
	internal static class Loading {
		...
		internal static void Load(string RouteFile, Encoding RouteEncoding) {
			// members
			OpenBveShared.Renderer.InitLoading(Program.FileSystem.GetDataFolder("In-game"), Renderer.ScreenWidth, Renderer.ScreenHeight, "Version " + typeof(Program).Assembly.GetName().Version);
			RouteProgress = 0.0;
			TrainProgress = 1.0;
