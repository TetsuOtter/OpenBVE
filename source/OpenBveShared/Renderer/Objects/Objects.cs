...
namespace OpenBveShared
{
	public static partial class Renderer
	{
		...
		public static void ShowObject(int ObjectIndex, ObjectType Type, TransparencyMode TransparencyQuality, bool CameraRestriction)
		{
			...
			if (GameObjectManager.Objects[ObjectIndex].RendererIndex == 0)
			{
				...
				for (int i = 0; i < f; i++)
				{
					...
					if (Type == ObjectType.Overlay & CameraRestriction)
					{
						alpha = true;
					}
